...
content = [
    ...
    ('align-content', 'Specifies the alignment between the lines inside a flexible container when the items do not use all available space.', properties_id),
    ('backface-visibility', 'Defines whether or not the back face of an element should be visible when facing the user.', properties_id),
    ('caption-side', 'Specifies the placement of a table caption.', properties_id),
    ('direction', 'Specifies the text direction/writing direction.', properties_id),
    ('empty-cells', 'Specifies whether or not to display borders and background on empty cells in a table.', properties_id),
